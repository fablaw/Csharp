  ...
  public class Lettre
  {
    ...
    public Person Destinataire{get;set;}
	  ...
	  public string CorpsLettre {get;set;}
		...
		public Lettre(Person expéditeur, Person destinataire)
		{
		...
		{
			Console.WriteLine("This letter was sent by {0}:{1} to {2}:{3} on {4}.", Expéditeur.FirstName, Expéditeur.EmailAdd, Destinataire.FirstName, Destinataire.EmailAdd, GetSendDate());
		}
	}
